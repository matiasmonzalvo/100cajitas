export const products = [
  {
    ...
    contents: [
      ...
      "Selección de carne seca premium",
      "Billetera de cuero",
    ...
    reviews: [
      {
        ...
        rating: 5,
        comment:
          "¡A mi papá le encantó esta caja de regalo! Todo era de alta calidad y hermosamente empaquetado.",
      },
      {
        name: "Michael S.",
        rating: 4,
        comment:
          "Gran selección de artículos. El vaso de whisky fue un gran éxito.",
      },
    ],
